...
function DetailRuas() {
    ...
    return (
        <div className={`bg-white w-[500px] rounded rounded-t-md p-0 ring-2 ring-white ${activated_modal_name === "DetailRuas" ? "flex flex-col" : "hidden"}`}>
            <div className="bg-blue-600 p-3 text-white flex items-center justify-center rounded-t-md font-bold text-lg">Detail Ruas</div>
